...
export default function InfiniteScroll({
  ...
  return (
    <div
      className="relative w-[1100px]   mt-[-100px] flex items-center justify-center  overflow-hidden overscroll-none border-t-2 border-b-2 border-t-dotted border-b-dotted border-transparent"
      ref={wrapperRef}
      style={{ maxHeight }}
    >
      ...
      <div
        className="flex flex-col pl-15 overscroll-contain px-4 cursor-grab origin-center"
        ref={containerRef}
        style={{
          width,
